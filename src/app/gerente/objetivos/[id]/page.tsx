  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] bg-zinc-50">
        ...
        <p className="mt-6 text-[10px] text-zinc-400 font-black uppercase tracking-[0.2em] italic">Sincronizando Nodo 704...</p>
      </div>
    );
  }
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            >
              <Hammer size={16} className="mr-2 text-[#D4AF37]" /> Editar Objetivo
            </Button>
            <Button 
              variant="outline" 
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-4 border-t border-zinc-100 space-y-3">
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="w-full p-3 text-xs font-semibold text-zinc-800 bg-zinc-50 border border-zinc-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/50 resize-none"
                      />
                      <Button
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-between items-center bg-white p-4 rounded-2xl border border-zinc-200 shadow-sm">
                ...
                <Button
                  ...
                  className="h-10 px-4 rounded-xl text-xs font-black uppercase tracking-widest gap-2 bg-zinc-900 text-white hover:bg-black transition-all shadow-md"
                >
                  <Printer size={15} className="text-[#D4AF37]" /> Imprimir Libro
                </Button>
              </div>
