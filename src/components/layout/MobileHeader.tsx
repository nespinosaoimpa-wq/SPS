...
export const MobileHeader = () => {
  return (
    <header className="lg:hidden fixed top-0 left-0 right-0 h-20 bg-zinc-950/80 backdrop-blur-2xl border-b border-white/5 z-[80] flex items-center justify-between px-6 safe-top">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-[13px] font-black text-white uppercase tracking-widest leading-none">SPS Business</h2>
          <p className="text-[8px] text-zinc-500 font-mono tracking-tighter uppercase mt-1">Operational Hub</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="relative w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-zinc-400">
          <Bell size={18} />
          <span className="absolute top-2.5 right-2.5 w-1.5 h-1.5 bg-primary rounded-full ring-2 ring-zinc-950 shadow-[0_0_8px_rgba(244,180,0,0.4)]" />
        </button>
      </div>
    </header>
  );
