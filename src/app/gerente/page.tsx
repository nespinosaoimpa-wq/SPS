...
export default function OperationalHub() {
  ...
  return (
    <div className="min-h-screen pl-32 pr-12 py-12 space-y-12 relative overflow-hidden bg-zinc-950">
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="flex flex-col items-end gap-4">
           <div className="flex gap-2 p-1 liquid-glass rounded-xl border-white/5 shadow-2xl">
              <Button variant="ghost" className="h-10 px-6 text-[9px] font-black uppercase tracking-widest text-white/40 hover:text-white transition-all">Reporte IA</Button>
              <Link href="/gerente/objetivos/nuevo">
      ...
      {/* 2. OPERATIONAL LAYOUT (Clean Grid) */}
      <div className="grid grid-cols-12 gap-8 h-[750px] relative">
        
        {/* TOP LEFT: BUSINESS KPIs */}
        <div className="col-span-12 lg:col-span-3 flex flex-col gap-6">
           {[
             { label: 'Facturación Bruta', value: '$12.4M', icon: DollarSign, trend: '+5.2%', color: 'text-green-500', note: 'MTD_REVENUE' },
             { label: 'Unidades en Puesto', value: activeResCount, icon: Building2, trend: '98%', color: 'text-primary', note: 'STAFF_ENGAGED' },
             { label: 'Riesgo Logístico', value: '0.04%', icon: TrendingUp, trend: 'Bajo', color: 'text-blue-500', note: 'COMPLIANCE_RATIO' },
           ].map((stat, i) => (
             <motion.div
               key={i}
        ...
        <div className="col-span-12 lg:col-span-6 relative">
           <div className="absolute inset-x-4 inset-y-0 liquid-glass rounded-[3rem] border-primary/20 overflow-hidden shadow-[0_0_100px_rgba(0,0,0,0.8)] z-0">
              
              {/* MONITOR OVERLAY */}
              <div className="absolute top-8 left-8 z-10 space-y-2">
                 <div className="flex items-center gap-4 bg-white/10 backdrop-blur-3xl px-6 py-3 rounded-full border border-white/10 group">
                    <div className="w-2 h-2 rounded-full bg-primary animate-pulse" />
                    <span className="text-[10px] font-black uppercase text-white tracking-widest">Monitor Global de Operaciones</span>
                 </div>
              </div>
              ...
              <div className="absolute bottom-12 inset-x-12 z-10 flex justify-between items-end">
                 <div className="space-y-4">
                    <div className="bg-white/10 backdrop-blur-md p-4 rounded-3xl border border-white/10 space-y-1">
                       <p className="text-[8px] text-zinc-400 uppercase font-black tracking-widest">Objetivos Activos</p>
        ...
        <div className="col-span-12 lg:col-span-3 flex flex-col gap-6">
           ...
           <div className="flex-1 liquid-glass rounded-[2rem] border-white/5 overflow-hidden flex flex-col">
              <div className="p-8 border-b border-white/10 flex items-center justify-between">
                 <div className="space-y-1">
                    <h4 className="text-[11px] font-black uppercase text-white tracking-[0.2em] flex items-center gap-2">
                      <Target size={14} className="text-primary" /> Monitor de Actividad
                    </h4>
                    <p className="text-[8px] text-zinc-500 font-mono italic">LIVE_FEED_V2</p>
                 </div>
                         ...
                         <div className="p-5 bg-white/5 border border-white/5 rounded-2xl group-hover:bg-primary/5 group-hover:border-primary/20 transition-all">
                            <div className="flex justify-between items-center mb-2">
                               <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-[9px] font-black uppercase text-white tracking-widest">{report.incident_type || 'Novedad'}</span>
                               </div>
              ...
              <div className="p-6 bg-black/40 text-center border-t border-white/10 group cursor-pointer">
                 <button className="text-[9px] text-zinc-600 uppercase font-black group-hover:text-primary transition-colors tracking-widest flex items-center justify-center gap-2 w-full">
                    Sincronizar Panel Administrativo <ChevronRight size={12} />
                 </button>
              </div>
           </div>
           ...
           <div className="p-8 bg-primary/10 border border-primary/20 rounded-[2rem] space-y-4">
              <div className="flex justify-between items-center">
                 ...
                 <span className="text-[10px] text-primary font-black">20 May</span>
              </div>
              <div className="h-1 w-full bg-white/10 rounded-full overflow-hidden">
                 <motion.div initial={{ width: 0 }} animate={{ width: '65%' }} className="h-full bg-primary" />
              </div>
              <p className="text-[8px] text-zinc-500 uppercase font-bold text-center">Gestión Pro-Activa de Obligaciones</p>
           </div>
