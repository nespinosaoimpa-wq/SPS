...
export function printGuardBookSheet(entries: any[], options: PrintGuardBookOptions = {}) {
  const companyName = options.companyName || 'SISTEMA INTEGRAL DE SEGURIDAD';
    ...
    <html>
      <head>
        ...
        <style>
          ...
          .header { border-bottom: 3px solid #18181b; padding-bottom: 12px; margin-bottom: 16px; display: flex; justify-content: space-between; align-items: flex-end; }
          .company { font-size: 10px; font-weight: 900; letter-spacing: 0.15em; text-transform: uppercase; color: #71717a; }
          ...
          th { background: #18181b; color: #ffffff; text-align: left; padding: 8px; font-size: 9px; font-weight: 900; text-transform: uppercase; letter-spacing: 0.1em; }
