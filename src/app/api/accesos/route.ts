...
export async function GET(req: NextRequest) {
  try {
    ...
    if (activeTenantId === SIGPAD_TEST_TENANT) {
      activeTenantId = MASTER_704_TENANT;
    }
...
export async function POST(request: NextRequest) {
  try {
    ...
    const activeTenantId = (tenant && tenant.tenantId) ? tenant.tenantId : 'a1b2c3d4-0001-0001-0001-000000000001';
